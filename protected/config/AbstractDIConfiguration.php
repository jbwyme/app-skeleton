 ...
 * @method inject($object, $protected=false)
 * @method load($path)
 * @method seal()
 */
 ...
 *
 * @property-read AbstractDIConfiguration $config self-reference to this configuration-container.
 */
abstract class AbstractDIConfiguration
{
    /**
